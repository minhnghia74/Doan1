...
public class MainActivity extends AppCompatActivity implements LocationListener {
    ...
    public void onMyMapReady(GoogleMap googleMap) {
        ...
        LatLng KTXKHUB = new LatLng(10.882249, 106.782571);
        mMap.addMarker(new MarkerOptions().position(KTXKHUB).title("Ký túc xá Khu B"));
        mMap.moveCamera(CameraUpdateFactory.newLatLngZoom(KTXKHUB,18));
